...
# app = Flask(__name__)
# api = Api(app)
# # # api.run(host= 'http://127.0.0.1:5000/')
# # # @app.route('/LEIs/v1.0/')
...
while Finished == False:
        try:
                ...
                # print(End)
                print('last page scrape completed: ', page)
                print('progress completed: ',calcPercentage(page,End))
        ...
        # Page finish logic
                ...
                #         continue
                # else:
                print("ERROR...see below message")
                print(ex)
                # keep exit command to application on error
                # exit()
